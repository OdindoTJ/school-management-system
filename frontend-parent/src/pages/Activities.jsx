...
const Activities = () => {
  ...
  useEffect(() => {
    ...
    const fetch = async () => {
      setLoading(true);
      try {
        const res = await parentAPI.getChildActivities(selectedChild.id);
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-500 text-sm mt-1">{selectedChild.full_name}'s activities</p>
      </div>
