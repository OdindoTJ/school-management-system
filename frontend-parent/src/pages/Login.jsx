...
import { parentAuthAPI, setTokens, setCurrentParent } from '../api/auth';
...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await parentAuthAPI.login(email, password);
      const { access, refresh, parent } = response.data;
    ...
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      <div className="hidden lg:block lg:w-1/2 relative overflow-hidden min-h-screen">
        ...
        <div className="absolute bottom-12 left-8 right-8 z-10 text-white">
          ...
          <h2 className="text-3xl font-bold mb-2">Stay connected to your child's journey</h2>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center bg-white p-6 sm:p-12 min-h-screen">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-500">Sign in to access your child's account.</p>
          </div>
          ...
          <div className="mt-8 pt-6 border-t border-gray-100 text-center">
            <p className="text-sm text-gray-500">
              ...
              <Link to="/accept-invitation" className="text-primary-900 font-medium hover:text-primary-700">
                Accept it here
              </Link>
            </p>
          </div>
